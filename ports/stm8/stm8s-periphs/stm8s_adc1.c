...
void ADC1_AWDChannelConfig(ADC1_Channel_TypeDef Channel, FunctionalState NewState)
{
    ...
    else
    {
        ...
        {
            ADC1->AWCRH &= (u8)~(u8)((u8)1 << (u8)(Channel - (u8)8));
        }
    }
}
...
u16 ADC1_GetBufferValue(u8 Buffer)
{
    ...
    {
        /* Read LSB first */
        templ = *(u8*)(u16)((u16)ADC1_BaseAddress + (u8)(Buffer << 1) + 1);
        /* Then read MSB */
        temph = *(u8*)(u16)((u16)ADC1_BaseAddress + (u8)(Buffer << 1));
...
FlagStatus ADC1_GetAWDChannelStatus(ADC1_Channel_TypeDef Channel)
{
    ...
    if (Channel < (u8)8)
    {
        status = (u8)(ADC1->AWSRL & (u8)((u8)1 << Channel));
    }
    else /* Channel = 8 | 9 */
    {
        status = (u8)(ADC1->AWSRH & (u8)((u8)1 << (Channel - (u8)8)));
    }
...
FlagStatus ADC1_GetFlagStatus(ADC1_Flag_TypeDef Flag)
{
    ...
    else if ((Flag & 0xF0) == 0x10)
    {
        ...
        temp = (u8)(Flag & (u8)0x0F);
        if (temp < 8)
        {
            flagstatus = (u8)(ADC1->AWSRL & (u8)((u8)1 << temp));
        }
        else
        {
            flagstatus = (u8)(ADC1->AWSRH & (u8)((u8)1 << (temp - 8)));
        }
    }
...
ITStatus ADC1_GetITStatus(ADC1_IT_TypeDef ITPendingBit)
{
    ...
    {
        /* Get analog watchdog channel status */
        temp = (u8)((u16)ITPendingBit & 0x0F);
        if (temp < 8)
        {
            itstatus = (ITStatus)(ADC1->AWSRL & (u8)((u8)1 << temp));
        }
        else
        {
            itstatus = (ITStatus)(ADC1->AWSRH & (u8)((u8)1 << (temp - 8)));
        }
    }
    else  /* Get EOC | AWD flag status */
    {
        itstatus = (ITStatus)(ADC1->CSR & (u8)ITPendingBit);
    }
...
void ADC1_ClearITPendingBit(ADC1_IT_TypeDef ITPendingBit)
{
    ...
    {
        ADC1->CSR &= (u8)((u16)~(u16)ITPendingBit);
    }
}
