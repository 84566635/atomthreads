...
typedef enum 
{
  ADC1_IT_AWDIE = (u16)0x010, /**< Analog WDG interrupt enable */
  ADC1_IT_EOCIE = (u16)0x020, /**< EOC interrupt enable */
  ...
  ADC1_IT_AWS12 = (u16)0x11C, /**< Analog channel 12 status */
                                   /* refer to product datasheet for channel 12 availability */
  ADC1_IT_EOC   = (u16)0x080  /**< EOC pending bit */
...
typedef enum 
{
  ...
  ADC1_FLAG_AWS12 = (u8)0x1C, /**< Analog channel 12 status */
                                  /* refer to product datasheet for channel 12 availability */
